...
public final class PathCommandBuilder {
        ...
        public static PathCommandBuilder fromAngle(DriveSubsystem drive, NavigationSubsystem nav, double angle){
                ...
                return new PathCommandBuilder(drive, nav, trajectory);
        }
